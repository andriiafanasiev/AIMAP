export const de = {
    ...
    hero: {
        title: 'KI-Tools Katalog',
        subtitle:
            'Entdecken Sie die Welt der künstlichen Intelligenz mit unserem Katalog von 100+ KI-Tools',
        search: 'Suche starten',
        explore: 'Mehr erfahren',
        tools: '100+ Tools',
        aiTech: 'KI-Technologien',
        fastSearch: 'Schnelle Suche',
    },
    catalog: {
        title: 'KI-Tools Katalog',
        subtitle: 'Finden Sie die besten KI-Tools für Ihre Bedürfnisse',
        search: 'KI-Tools suchen...',
        filters: 'Filter',
        clear: 'Löschen',
        selected: 'Ausgewählt',
        categories: 'Kategorien',
        found: 'Gefunden',
        tools: 'Tools',
        filtered: 'Gefiltert nach',
        noResults: 'Nichts gefunden',
        noResultsDesc: 'Versuchen Sie, Ihre Suchanfrage oder Filter zu ändern',
        free: 'Kostenlos',
        api: 'API',
