export const en = {
    ...
    hero: {
        ...
        subtitle:
            'Discover the world of artificial intelligence with our catalog of 100+ AI tools',
        search: 'Start Search',
        explore: 'Learn More',
        tools: '100+ tools',
        aiTech: 'AI technologies',
        fastSearch: 'Fast search',
    },
    catalog: {
        title: 'AI Tools Catalog',
        subtitle: 'Find the best AI tools for your needs',
        ...
        noResultsDesc: 'Try changing your search query or filters',
        free: 'Free',
        api: 'API',
